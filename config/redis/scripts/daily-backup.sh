...
aws s3 cp /backups/$LATEST_BACKUP/dump.rdb s3://blot-daily-backups/$LATEST_BACKUP-dump.rdb
...
# will do nothing.
aws s3 ls s3://blot-daily-backups/ | sort -r | tail -n +11 | awk '{print $4}' | xargs -I {} aws s3 rm s3://blot-daily-backups/{}
