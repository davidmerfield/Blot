...
function tests () {
  ...
  res('http://i.imgur.com/2GybVZX.jpg',
      'http://i.imgur.com/2GybVZX.jpg');

  res('https://i.imgur.com/2GybVZX.jpg',
      'https://i.imgur.com/2GybVZX.jpg');

  res('image.png',
      'http://david.blot.im/image.png',
      'http://david.blot.im');
