...
module.exports = function () {
  ...
  fonts.forEach(function(name){
    ...
    var datauri = new DataURI(__dirname + '/fonts/' + name);
    var format = name.slice(name.lastIndexOf('.') + 1);

    css = css.split(name).join('data:application/x-font-' + format + ';charset=utf-8;base64,' + datauri.base64);
  });
