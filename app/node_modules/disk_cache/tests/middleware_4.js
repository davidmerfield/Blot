...
function disk_cache (req, res, next) {
  ...
  res.write = function write (chunk, encoding) {
    ...
    debug('res.write called - ended:', ended);
  ...
  res.end = function end (chunk, encoding) {
    ...
    if (chunk) {
      ...
      debug('calling stream.end with chunk');
    ...
    if (!chunk) {
      debug('calling _end');
      _end.call(this);
      debug('calling stream.end without chunk');
      return stream.end();
    }
  };
  ...
  function nocompress (msg) {
    ...
    onHeaders(res, function onResponseHeaders () {
      ...
      if (res.statusCode !== 200) {
        nocompress('BAD status ' + req.originalUrl + ' ' + res.statusCode);
        return;
      }
