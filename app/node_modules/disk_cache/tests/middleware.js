...
function disk_cache (req, res, next) {
  ...
  res.write = function write (chunk, encoding) {
    ...
    console.log('WRITE', !!stream, fullurl, chunk.toString().slice(0, 15));
    // if (stream)
  ...
  res.end = function end (chunk, encoding) {
    ...
    if (chunk) console.log('END', !!stream, fullurl, chunk.toString().slice(0, 15));
    if (!chunk) console.log('END',!!stream, fullurl);
