...
!(function (a, b) {
  ...
  (n.event = {
    ...
    n.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function (
      a,
      b
    ) {
      n.event.special[a] = {
  ...
  (o.prototype.listen = function () {
    ...
    (o.prototype._zoom = function (o) {
      ...
      if (e && "IMG" == e.tagName && !this._$body.hasClass("zoom-overlay-open"))
        return o.metaKey
          ? window.open(o.target.src, "_blank")
          : void (
              e.width >= window.innerWidth - i.OFFSET ||
    ...
    (i.prototype._triggerAnimation = function () {
      ...
      (this._translateY = e - s),
        (this._translateX = a - r),
    ...
    (i.prototype.close = function () {
      this._$body
        ...
        t(this._targetImage).css("transform", ""),
        t(this._targetImageWrap).css("transform", ""),
        t(this._targetImage)
