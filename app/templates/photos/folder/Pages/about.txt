...
- [Download a copy of the folder](/folder.zip) (22mb) from which this site is generated if you are interested in how the photos are organized. 
- [View the source for this template](). Blot's source code, including this template, is dedicated to the public domain.
- [View the source file for this page](?source=true)
...
The images on this site are courtesy of the [IEMS](http://iems-ferox.com). Many thanks to the brave souls on the [Ferox expedition](http://iems-ferox.com) for their kind contributions to the public domain. In particular, I'd like to extend a warm handshake to EESA Director Dwight M. Müller.
