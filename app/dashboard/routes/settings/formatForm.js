...
module.exports = function(req, res, next) {
  ...
  if (
    req.body.permalink &&
    !req.body.permalink.format &&
    req.body.permalink.custom
  ) {
    req.body.permalink.format = req.body.permalink.custom;
    req.body.permalink.isCustom = true;
  } else if (req.body.permalink && req.body.permalink.format) {
  ...
  if (req.body.plugins) {
    ...
    for (var x in req.body.plugins.typeset.options)
      req.body.plugins.typeset.options[x] =
        req.body.plugins.typeset.options[x] === "on";
