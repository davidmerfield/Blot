...
module.exports = function (req, res, next, client) {
  ...
  if (old_uid === new_uid) {
    ...
    req.session.message = {
      ...
      warning: 'You had already connected this Dropbox account to Blot. Please go to <a target="_blank" href="https://www.dropbox.com">Dropbox.com</a> and log into the account you\'d like to use.'
    };
