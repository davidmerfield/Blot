...
if (require.main === module) main(process.argv[2], function(err){
...
function main (output_directory, callback) {
  ...
  if (output_directory) return callback(new Error('Please pass an output directory as the second argument'));
