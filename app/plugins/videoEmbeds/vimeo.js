...
function template (id, ratio) {
  return '<div style="width:0;height:0"> </div><div class="videoContainer vimeo" style="padding-bottom: ' + ratio + '%"><iframe src="//player.vimeo.com/video/' + id + '?badge=0&color=ffffff&byline=0&portrait=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>';
}
