  ...
  mkdirp(outDir, function(err){
    ...
    fs.stat(localPath, function(err, stat){
      ...
      exec(pandoc_path + ' ' + args, function(err, stdout, stderr){
        ...
        if (err) {
          return callback(new Error('Pandoc exited with code ' + err + ' and message ' + stderr));
        }
        ...
        fs.readFile(outPath, 'utf-8', function(err, html){
          ...
          $('p').each(function(){
            ...
            if (children.length === 1 && text && strongText && text === strongText) {
          ...
          $('li').each(function(){
            ...
            if (children.length === 1 && text && blockquoteText && text === blockquoteText)
