...
const DISK_SPACE_WARNING_THRESHOLD = 1e9; // 1GB
const ICLOUD_SPACE_WARNING_THRESHOLD = 1e9; // 1GB

const DISK_SPACE_LIMIT = 1e8; // 100MB
const ICLOUD_SPACE_LIMIT = 1e8; // 100MB
...
module.exports = async () => {
  setInterval(async () => {
    ...
    try {
      ...
      if (!stats || !stats.disk_bytes_available || !stats.icloud_bytes_available) {
      ...
      } else if (stats.icloud_bytes_available < ICLOUD_SPACE_WARNING_THRESHOLD) {
