...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: shared/register_partial</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: shared/register_partial</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Registers partials on a template.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="register_partial.js.html">shared/register_partial.js</a>, <a href="register_partial.js.html#line1">line 1</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="registerPartial"><span class="type-signature">(static) </span>registerPartial<span class="signature">(name, template)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The name to register.</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">The template to use as a partial.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="register_partial.js.html">shared/register_partial.js</a>, <a href="register_partial.js.html#line16">line 16</a>
    </li></ul></dd>
