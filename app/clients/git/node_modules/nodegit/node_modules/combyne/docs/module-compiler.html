...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: compiler</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: compiler</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Compiles a template Tree into JavaScript.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="compiler.js.html">compiler.js</a>, <a href="compiler.js.html#line1">line 1</a>
    </li></ul></dd>
        ...
        <ul>
            <li><a href="register_partial.html">module:shared/register_partial</a></li>
        
            <li><a href="register_filter.html">module:shared/register_filter</a></li>
        
            <li>module:shared/map</li>
        
            <li><a href="encode.html">module:shared/encode</a></li>
        
            <li><a href="type.html">module:utils/type</a></li>
        
            <li><a href="create_object.html">module:utils/create_object</a></li>
        </ul>
        ...
        <dl>
            <dt><a href="module-compiler.Compiler.html">Compiler</a></dt>
            <dd></dd>
        </dl>
