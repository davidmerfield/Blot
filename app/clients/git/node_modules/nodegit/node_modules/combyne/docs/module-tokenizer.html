...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: tokenizer</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: tokenizer</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Deconstructs a template into tokens.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="tokenizer.js.html">tokenizer.js</a>, <a href="tokenizer.js.html#line1">line 1</a>
    </li></ul></dd>
        ...
        <dl>
            <dt><a href="module-tokenizer.Tokenizer.html">Tokenizer</a></dt>
            <dd></dd>
        </dl>
