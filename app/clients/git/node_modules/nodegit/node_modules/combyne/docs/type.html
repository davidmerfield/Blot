...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: utils/type</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: utils/type</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Determines the type of a passed in value.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="type.js.html">utils/type.js</a>, <a href="type.js.html#line1">line 1</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="type"><span class="type-signature">(static) </span>type<span class="signature">(value)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<span class="param-type">*</span>
            ...
            <td class="description last">A value to test.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="type.js.html">utils/type.js</a>, <a href="type.js.html#line16">line 16</a>
    </li></ul></dd>
