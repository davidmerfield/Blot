...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: grammar</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: grammar</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Defines the grammer to use when parsing the template for tokens.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="grammar.js.html">grammar.js</a>, <a href="grammar.js.html#line1">line 1</a>
    </li></ul></dd>
        ...
        <ul>
            <li><a href="escape_delimiter.html">module:utils/escape_delimiter</a></li>
        </ul>
        ...
        <dl>
            <dt><a href="module-grammar.Grammar.html">Grammar</a></dt>
            <dd></dd>
        </dl>
