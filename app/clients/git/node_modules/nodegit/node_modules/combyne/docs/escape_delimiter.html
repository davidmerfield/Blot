...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: utils/escape_delimiter</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: utils/escape_delimiter</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Safely escapes Strings to be used as delimiters via RegExp.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="escape_delimiter.js.html">utils/escape_delimiter.js</a>, <a href="escape_delimiter.js.html#line1">line 1</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="escapeDelimiter"><span class="type-signature">(static) </span>escapeDelimiter<span class="signature">(delimiter)</span><span class="type-signature"> &rarr; {String}</span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The value to escape.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="escape_delimiter.js.html">utils/escape_delimiter.js</a>, <a href="escape_delimiter.js.html#line18">line 18</a>
    </li></ul></dd>
...
<div class="param-desc">
    A safe value for RegExp building.
</div>
