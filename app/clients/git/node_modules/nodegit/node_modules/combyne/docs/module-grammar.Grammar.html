...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Grammar</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Grammar</h1>
...
<header>
    <h2>
        <span class="ancestors"><a href="module-grammar.html">grammar</a>.</span>
...
<dt>
    <h4 class="name" id="Grammar"><span class="type-signature"></span>new Grammar<span class="signature">(delimiters)</span><span class="type-signature"></span></h4>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Delimiters to use store and use internally.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="grammar.js.html">grammar.js</a>, <a href="grammar.js.html#line24">line 24</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="escape"><span class="type-signature">(static) </span>Grammar#escape<span class="signature">()</span><span class="type-signature"> &rarr; {array}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="grammar.js.html">grammar.js</a>, <a href="grammar.js.html#line74">line 74</a>
    </li></ul></dd>
...
<div class="param-desc">
    Metadata describing the grammar.
</div>
