    ...
    NAN_SETTER(GitDiffOptions::SetNotifyCb) {
      ...
      void GitDiffOptions::notify_cb_async(void *untypedBaton) {
        ...
        if (instance->notify_cb.GetCallback()->IsEmpty()) {
          ...
          return;
               ...
               v8::Local<Value> argv[4] = {
                  GitDiff::New(baton->diff_so_far, false),
        ...
        Nan::TryCatch tryCatch;
            ...
            v8::Local<v8::Value> result = instance->notify_cb.GetCallback()->Call(4, argv);
      ...
      void GitDiffOptions::progress_cb_async(void *untypedBaton) {
        ...
        if (instance->progress_cb.GetCallback()->IsEmpty()) {
          ...
          return;
                ...
                if (baton->old_path == NULL) {
                  baton->old_path = "";
              }
                if (baton->new_path == NULL) {
                  baton->new_path = "";
              }
               v8::Local<Value> argv[4] = {
                  GitDiff::New(baton->diff_so_far, false),
        ...
        Nan::TryCatch tryCatch;
            ...
            v8::Local<v8::Value> result = instance->progress_cb.GetCallback()->Call(4, argv);
