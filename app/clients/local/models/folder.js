...
// Stores the source folder for a given blog
// against the blog's ID. We need to be able to
// list all blogs when the server starts so that
// we can begin watching those folders for changes.
module.exports = {
